Last login: Wed May 19 07:30:42 on console
inamurateppei@mbp ~ % ssh-keygen
Generating public/private rsa key pair.
Enter file in which to save the key (/Users/inamurateppei/.ssh/id_rsa): 
Enter passphrase (empty for no passphrase): 
Enter same passphrase again: 
Your identification has been saved in /Users/inamurateppei/.ssh/id_rsa.
Your public key has been saved in /Users/inamurateppei/.ssh/id_rsa.pub.
The key fingerprint is:
SHA256:nvgxtYAO6ls0hzQa+IOo33u6EIAFelt3+M1IDQDTvDw inamurateppei@mbp.local
...
|  +.==  .        |
+----[SHA256]-----+
inamurateppei@mbp ~ % cat ~/.ssh/id_rsa.pub     
ssh-rsa  inamurateppei@mbp.local
inamurateppei@mbp ~ % ssh-keygen
Generating public/private rsa key pair.
Enter file in which to save the key (/Users/inamurateppei/.ssh/id_rsa): 
/Users/inamurateppei/.ssh/id_rsa already exists.
Overwrite (y/n)? y
Enter passphrase (empty for no passphrase): 
Enter same passphrase again: 
Your identification has been saved in /Users/inamurateppei/.ssh/id_rsa.
Your public key has been saved in /Users/inamurateppei/.ssh/id_rsa.pub.
The key fingerprint is:
SHA256:E8YE8ExKQAx72h8dhUzF98newHvHVObKkwbEqEQ2jEU inamurateppei@mbp.local
The key's randomart image is:
+---[RSA 3072]----+
|.+o.o++@E  o     |
| ... =+=+.o o   o|
...
+----[SHA256]-----+
inamurateppei@mbp ~ % cat ~/.ssh/id_rsa.pub
ssh-rsa  inamurateppei@mbp.local
inamurateppei@mbp ~ % cat ~/.ssh/id_rsa.pub | pbcopy
inamurateppei@mbp ~ % cat ~/.ssh/id_rsa.pub | pbcopy
inamurateppei@mbp ~ % Host git-codecommit.*.amazonaws.com
zsh: no matches found: git-codecommit.*.amazonaws.com
inamurateppei@mbp ~ % ~/.ssh/config
zsh: no such file or directory: /Users/inamurateppei/.ssh/config
inamurateppei@mbp ~ % ~/.ssh/config
zsh: no such file or directory: /Users/inamurateppei/.ssh/config
inamurateppei@mbp ~ % ~/.ssh
zsh: permission denied: /Users/inamurateppei/.ssh
inamurateppei@mbp ~ % cd .ssh/id_rsa.pub          
cd: not a directory: .ssh/id_rsa.pub
inamurateppei@mbp ~ % cd .ssh
inamurateppei@mbp .ssh % ls
3c8DhJdfef.pem			known_hosts
id_rsa				test-inamura.pem
id_rsa.pub			test_inamura_keypair.pem
inamurateppei@mbp .ssh % Host git-codecommit.*.amazonaws.com
zsh: no matches found: git-codecommit.*.amazonaws.com
inamurateppei@mbp .ssh % Host git-codecommit.*.amazonaws.com
...
id_rsa				test-inamura.pem
id_rsa.pub			test_inamura_keypair.pem
inamurateppei@mbp .ssh % cd
inamurateppei@mbp ~ % aws codecommit help
inamurateppei@mbp ~ % 
inamurateppei@mbp ~ % aws configure
AWS Access Key ID [None]: 
AWS Secret Access Key [None]: 
Default region name [None]: 
Default output format [None]: 
inamurateppei@mbp ~ % aws configure
AWS Access Key ID [None]: AKIAXTI5IPNOHSLJ22QY
AWS Secret Access Key [None]: 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
...
id_rsa				test-inamura.pem
id_rsa.pub			test_inamura_keypair.pem
inamurateppei@mbp .ssh % cd config
cd: no such file or directory: config
inamurateppei@mbp .ssh % cd     
inamurateppei@mbp ~ % mkdir ~/.ssh
mkdir: /Users/inamurateppei/.ssh: File exists
inamurateppei@mbp ~ % chmod 700 .ssh
inamurateppei@mbp ~ % touch ~/.ssh/config
inamurateppei@mbp ~ % cd .ssh
inamurateppei@mbp .ssh % ls
3c8DhJdfef.pem			known_hosts
config				test-inamura.pem
id_rsa				test_inamura_keypair.pem
id_rsa.pub
inamurateppei@mbp .ssh % cat config
inamurateppei@mbp .ssh % cd config
cd: not a directory: config
inamurateppei@mbp .ssh % vim config
inamurateppei@mbp .ssh % cat config 
Host git-codecommit.*.amazonaws.com
  User APKAXTI5IPNOC2KVLF4P
  IdentityFile ~/.ssh/id_rsa
inamurateppei@mbp .ssh % cd
inamurateppei@mbp ~ % ssh://git-codecommit.ap-northeast-1.amazonaws.com/v1/repos/sample
zsh: no such file or directory: ssh://git-codecommit.ap-northeast-1.amazonaws.com/v1/repos/sample
inamurateppei@mbp ~ % ssh://git-codecommit.ap-northeast-1.amazonaws.com/v1/repos/IWwedding
zsh: no such file or directory: ssh://git-codecommit.ap-northeast-1.amazonaws.com/v1/repos/IWwedding
inamurateppei@mbp ~ % chmod 700 config
chmod: config: No such file or directory
inamurateppei@mbp ~ % git clone ssh://git-codecommit.ap-northeast-1.amazonaws.com/v1/repos/IWwedding
Cloning into 'IWwedding'...
...
Enter passphrase for key '/Users/inamurateppei/.ssh/id_rsa': 
warning: You appear to have cloned an empty repository.
inamurateppei@mbp ~ % aws config
...
inamurateppei@mbp ~ % aws configure
AWS Access Key ID [****************22QY]: 
AWS Secret Access Key [****************KuVL]: 
Default region name [ap-northeast-1]: 
Default output format [yaml]: 
inamurateppei@mbp ~ % aws configure list
...
inamurateppei@mbp ~ % git clone ssh://git-codecommit.ap-northeast-1.amazonaws.com/v1/repos/IWwedding
fatal: destination path 'IWwedding' already exists and is not an empty directory.
inamurateppei@mbp ~ % aws configure list
      Name                    Value             Type    Location
      ----                    -----             ----    --------
   profile                <not set>             None    None
...
secret_key     ****************traq              env    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % aws configure --profile user
AWS Access Key ID [None]: AKIAXTI5IPNOHSLJ22QY
AWS Secret Access Key [None]: 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
Default region name [None]: ap-northeast-1 
Default output format [None]: json
inamurateppei@mbp ~ % aws iam list-users
...
secret_key     ****************traq              env    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % aws configure list --profile user
      Name                    Value             Type    Location
      ----                    -----             ----    --------
   profile                     user           manual    --profile
access_key     ****************22QY shared-credentials-file    
secret_key     ****************KuVL shared-credentials-file    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % export AWS_DEFAULT_PROFILE=user 
inamurateppei@mbp ~ % aws configure list               
      Name                    Value             Type    Location
      ----                    -----             ----    --------
   profile                     user           manual    --profile
...
secret_key     ****************traq              env    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % export AWS_PROFILE=user
inamurateppei@mbp ~ % aws configure list     
      Name                    Value             Type    Location
      ----                    -----             ----    --------
   profile                     user           manual    --profile
...
secret_key     ****************traq              env    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % aws configure --profile user1
AWS Access Key ID [None]: AKIAXTI5IPNOHSLJ22QY
AWS Secret Access Key [None]: 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
Default region name [None]: ap-northeast-1
Default output format [None]: json
...
secret_key     ****************traq              env    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % export AWS_PROFILE=user1     
inamurateppei@mbp ~ % aws configure list      
      Name                    Value             Type    Location
      ----                    -----             ----    --------
...
secret_key     ****************traq              env    
    region           ap-northeast-1              env    ['AWS_REGION', 'AWS_DEFAULT_REGION']
inamurateppei@mbp ~ % .cd
zsh: command not found: .cd
inamurateppei@mbp ~ % ls
Applications		IWwedding		Public
Creative Cloud Files	Library			Sinatra
Desktop			Movies			VirtualBox VMs
Documents		Music			create
Downloads		MyVagrant		matter
Dropbox			Pictures		projects
inamurateppei@mbp ~ % cd .cd
...
Host git-codecommit.*.amazonaws.com
  ...
  IdentityFile ~/.ssh/id_rsa
inamurateppei@mbp .ssh % cd
inamurateppei@mbp ~ % cat .aws/config
[default]
...
region = ap-northeast-1
output = json
inamurateppei@mbp ~ % cat .aws/credentials
[default]
aws_access_key_id = AKIAXTI5IPNOHSLJ22QY
aws_secret_access_key = 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
[user]
aws_access_key_id = AKIAXTI5IPNOHSLJ22QY
aws_secret_access_key = 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
[user1]
...
fatal: destination path 'IWwedding' already exists and is not an empty directory.
inamurateppei@mbp ~ % echo IWwedding > readme.md
inamurateppei@mbp ~ % git add *
fatal: not a git repository (or any of the parent directories): .git
inamurateppei@mbp ~ % git add* 
zsh: no matches found: add*
inamurateppei@mbp ~ % git add *
fatal: not a git repository (or any of the parent directories): .git
inamurateppei@mbp ~ % git commit -m "first Commit"
fatal: not a git repository (or any of the parent directories): .git
inamurateppei@mbp ~ % ls
...
inamurateppei@mbp projects % python -m pip install line-bot-sdk -t .
/System/Library/Frameworks/Python.framework/Versions/2.7/Resources/Python.app/Contents/MacOS/Python: No module named pip
inamurateppei@mbp projects % python -v
